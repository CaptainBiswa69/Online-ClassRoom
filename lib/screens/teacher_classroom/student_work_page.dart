...
class StudentWorkPage extends StatefulWidget {
  ...
  const StudentWorkPage({super.key, required this.student, required this.classRoom});

  @override
  State<StudentWorkPage> createState() => _StudentWorkPageState();
}
    ...
    return Scaffold(
        ...
        body: ListView(
            children: [
              ...
              if (submittedWork.isNotEmpty) Container(
              ...
              if (assignedWork.isNotEmpty) Container(
                padding: const EdgeInsets.only(top: 15, left: 15, bottom: 10),
                child: Text(
                  "Pending",
                  style: TextStyle(
