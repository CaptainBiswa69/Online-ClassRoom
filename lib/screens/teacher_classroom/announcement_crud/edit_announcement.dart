...
class EditAnnouncement extends StatefulWidget {
  ...
  const EditAnnouncement({super.key, required this.announcement});
...
class _EditAnnouncementState extends State<EditAnnouncement> {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime defaultDate = DateFormat('h:mm a EEE, MMM d, yyyy')
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          await AnnouncementDB(user: user).updateAnnouncements(
                              title,
                              description,
                              widget.announcement.classroom.className,
                              dateTime,
